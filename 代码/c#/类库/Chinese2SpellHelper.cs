...
namespace ConsoleApplication2
{
    ...
    /// 参考网站  https://blog.csdn.net/zhichao2001/article/details/54237553
    /// </summary>
    public static class Chinese2SpellHelper
    {
        ...
        public static bool MatchedZHCN(string sentence)
        {
            ...
            return System.Text.RegularExpressions.Regex.IsMatch(sentence, @"[\u4e00-\u9fa5]");
        }    

...
class unicodeHelper:
    ...
    @classmethod
    def Unicode2HexStr(seft,Unicde_Str):
        Hex_Str = ""
        try:
    ...
    *Description：  16进制数转换为Unicode字符串
    *Input:  Hex_Str 16进制数
    *Return: Unicde_Str Unicode字符串
    *Others:
    '''
    @classmethod
    def HexData2Unicode(seft,Hex_Str):
        Unicde_Str = ""
        try:
            Hex_Str = str(hex(Hex_Str)).replace("0x", "")
